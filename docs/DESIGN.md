...
> Design notes for **legal-matter-document-qa** — a runnable typescript example that Typed Node service for legal document questions and deadline follow-up.
...
- **Feature code** — the actual task: legal document intake.
